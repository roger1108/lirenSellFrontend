...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
        ...
        // function create12Random(){                // roger change start
        //   let num = '';
        //   for(let i=0;i<12;i++){
        ...
        // };
        // if(!getCookie('openid'))
        //   this.$route.query.openid = create12Random()// roger change end

        //如果url里有openid, 设置进cookie
        //var openid = this.$route.query.openid;
        //console.log("router:"+ getCookie('openid') )
        ...
        //   setTimeout(()=>{
        //     console.log("wait 1 second: the openId is:"+getCookie('openid'));
        //   },1000)
