                    ...
                    <ul  class="cart-item" v-for="orderDetail in orderDetailList">
                        <li  class="product-item">
                            ...
                            <div  class="price-wrap">
                                ...
                                <span >￡{{orderDetail.productPrice * orderDetail.productQuantity}}</span>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div  class="detailcard" >
                ...
                <div  class="detailcard-order card">
                    ...
                    <ul  class="cardlist">
                        ...
                        <!--roger change start <li  class="listitem"><span >支付方式：</span>{{order.payType | payName}} </li> -->
                        <li  class="listitem"><span >支付方式：</span>到店支付</span></li>
